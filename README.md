    ...
    <section id="noticias">
        <div class="article">
            ...
            <ul>
                ...
                <li>Manu Ginobili dio las siguientes declaraciones sobre LeBron James: "Ese negro pelotudo para lo unico que tenia las manos era para comer bananas" mientras hacia repetidos gestos imitando a un mono 🐒🐒🐒.</li>
